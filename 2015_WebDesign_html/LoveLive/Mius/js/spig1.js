...
jQuery(document).ready(function ($) {
    ...
    $(".mumu").mouseover(function () {
       $(".mumu").fadeTo("300", 0.3);
       msgs = ["总有一天，我会让这里座无虚席！", "我们的Love，我们的Live！","宝宝通什么的最有爱了~！", "罗老师什么的，最喜欢了╰(￣▽￣)╮", "向着我们的目标，前进~！"];
...
jQuery(document).ready(function ($) {
    window.setInterval(function () {
        msgs = ["宝宝通什么的最有爱了~！","从前有座山，山上有座庙，庙里有个老和尚给小和尚讲故事，讲：“从前有座……”"];
        var i = Math.floor(Math.random() * msgs.length);
...
jQuery(document).ready(function ($) {
    window.setInterval(function () {
        msgs = ["μ's最喜欢了~！", "我飘过来了！~", "我飘过去了", "我得意地飘！~飘！~"];
        var i = Math.floor(Math.random() * msgs.length);
